In this project i applied almost all ReactJs features including Hooks (useState, useEffect, useReducer..),Hoc.. I Also used Redux, redux-saga library and react-router.
