...
const BuildControls = (props) => {
    ...
    return (
        ...
        <button className={classes.OrderButton} disabled={!props.purchasable} onClick={props.orderButtonHandler}> {props.isAuthenticated? 'Order now' : 'SIGN IN TO ORDER' }</button>
